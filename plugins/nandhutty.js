...
r_text[1] = "*Nandhutty ye tholpikkaan നിങ്ങൾക്കാവില്ല.* *Jeevitathil Nandhutty ye* *tholpichittundu…* *palarum…* *palavattom…😥😥* *aarellum aaa sed bgm onn iduo...*";
r_text[2] = "*Whitedevil says i love you 😘*";
r_text[3] = "*Nandhutty yude yudhangal Company Kanan Povunnatheyuloo*";
r_text[4] = "*hi, how are you*";
r_text[5] = "*ennikk korch rest theroo...🥵🥵*";
r_text[6] = "*Nandhutty* - *eva* - *simsim* \n *ingane ethra ethra paerugal aan alle enikk..😂🤣*";
...
r_text[8] = "\n enne vilicho...?🧐 \n";
r_text[9] = "ente per Nandhutty ,ninte per donkey, backi ellarum monkey😼😼";
r_text[10] = "nee vilicha enikk villi kelkathe irrikkaan pattuo";
r_text[11] = "do you know who are my creator's..? its none other than Ajmal and Achu";
...
r_text[13] = ".song adich thangalude fav song name para Nandhutty ath download aakki theraam";
...
r_text[21] = "*Keralam pazhaya keralamellennariyam… pakshe Whitedevil pazhaya Nandhutty thanneya...😎* \n\n";
r_text[22] = "Kaanaan oru look illanney ullu… bhayankara budhiya\n\n ninnak allatto enik Nandhuttyk";
