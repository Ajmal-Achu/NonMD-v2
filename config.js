...
module.exports = {
    ...
    SESSION: process.env.ACHOOS_SESSION === undefined ? '' : process.env.ACHOOS_SESSION,
    ANTİLİNK: process.env.ANTİ_LİNK === undefined ? 'false' : process.env.ANTİ_LİNK,
    AUTOBİO: process.env.AUTO_BİO === undefined ? 'false' : process.env.AUTO_BİO,
    GANSTYLE: process.env.GAN_IMAGE === undefined ? 'https://i.imgur.com/KaFgao3.jpeg' : process.env.GAN_IMAGE,
    ...
    ALL: process.env.ALL_CAPTION === undefined ? 'Made By Achoos' : process.env.ALL_CAPTION,
    MENTION: process.env.TAG_REPLY === undefined ? '919074916607@s.whatsapp.net' : process.env.TAG_REPLY,
